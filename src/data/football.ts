...
export const footballPlayers: Player[] = [
    // Legends
    {
        id: 'f-1', name: 'Zinedine Zidane', birthDate: '1972-06-23', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-2', name: 'Pelé', birthDate: '1940-10-23', sport: 'football', category: 'historical',
        clubs: [{ name: 'Santos', years: '1956-1974' }, { name: 'New York Cosmos', years: '1975-1977' }]
    },
    {
        id: 'f-3', name: 'Diego Maradona', birthDate: '1960-10-30', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-4', name: 'Johan Cruyff', birthDate: '1947-04-25', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-5', name: 'Michel Platini', birthDate: '1955-06-21', sport: 'football', category: 'historical',
        clubs: [{ name: 'Nancy', years: '1972-1979' }, { name: 'Saint-Étienne', years: '1979-1982' }, { name: 'Juventus', years: '1982-1987' }]
    },
    {
        id: 'f-6', name: 'Ronaldo Nazário', birthDate: '1976-09-18', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-7', name: 'Ronaldinho', birthDate: '1980-03-21', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-8', name: 'Thierry Henry', birthDate: '1977-08-17', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-9', name: 'Zlatan Ibrahimović', birthDate: '1981-10-03', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-10', name: 'Andrés Iniesta', birthDate: '1984-05-11', sport: 'football', category: 'historical',
        clubs: [{ name: 'Barcelona', years: '2002-2018' }, { name: 'Vissel Kobe', years: '2018-2023' }]
    },
    // Modern Stars
    {
        id: 'f-11', name: 'Lionel Messi', birthDate: '1987-06-24', sport: 'football', category: 'active',
        clubs: [{ name: 'Barcelona', years: '2004-2021' }, { name: 'PSG', years: '2021-2023' }, { name: 'Inter Miami', years: '2023-' }]
    },
    {
        id: 'f-12', name: 'Cristiano Ronaldo', birthDate: '1985-02-05', sport: 'football', category: 'active',
    ...
    {
        id: 'f-22', name: 'Sergio Ramos', birthDate: '1986-03-30', sport: 'football', category: 'active',
    ...
    {
        id: 'f-23', name: 'Manuel Neuer', birthDate: '1986-03-27', sport: 'football', category: 'active',
        clubs: [{ name: 'Schalke 04', years: '2006-2011' }, { name: 'Bayern Munich', years: '2011-' }]
    },
    {
        id: 'f-24', name: 'Gareth Bale', birthDate: '1989-07-16', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-25', name: 'Eden Hazard', birthDate: '1991-01-07', sport: 'football', category: 'historical',
        clubs: [{ name: 'Lille', years: '2007-2012' }, { name: 'Chelsea', years: '2012-2019' }, { name: 'Real Madrid', years: '2019-2023' }]
    },
    {
        id: 'f-26', name: 'Toni Kroos', birthDate: '1990-01-04', sport: 'football', category: 'historical',
        clubs: [{ name: 'Bayern Munich', years: '2007-2014' }, { name: 'Leverkusen', years: '2009-2010' }, { name: 'Real Madrid', years: '2014-2024' }]
    },
    {
        id: 'f-27', name: 'Harry Kane', birthDate: '1993-07-28', sport: 'football', category: 'active',
        clubs: [{ name: 'Tottenham', years: '2009-2023' }, { name: 'Bayern Munich', years: '2023-' }]
    },
    {
        id: 'f-28', name: 'Virgil van Dijk', birthDate: '1991-07-08', sport: 'football', category: 'active',
    ...
    {
        id: 'f-29', name: 'Antoine Griezmann', birthDate: '1991-03-21', sport: 'football', category: 'active',
    ...
    {
        id: 'f-30', name: 'Luis Suárez', birthDate: '1987-01-24', sport: 'football', category: 'active',
    ...
    // Icons
    {
        id: 'f-31', name: 'Kaká', birthDate: '1982-04-22', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-32', name: 'Xavi', birthDate: '1980-01-25', sport: 'football', category: 'historical',
        clubs: [{ name: 'Barcelona', years: '1998-2015' }, { name: 'Al Sadd', years: '2015-2019' }]
    },
    {
        id: 'f-33', name: 'Iker Casillas', birthDate: '1981-05-20', sport: 'football', category: 'historical',
        clubs: [{ name: 'Real Madrid', years: '1999-2015' }, { name: 'Porto', years: '2015-2020' }]
    },
    {
        id: 'f-34', name: 'Gianluigi Buffon', birthDate: '1978-01-28', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-35', name: 'Paolo Maldini', birthDate: '1968-06-26', sport: 'football', category: 'historical',
        clubs: [{ name: 'AC Milan', years: '1984-2009' }]
    },
    {
        id: 'f-36', name: 'Didier Drogba', birthDate: '1978-03-11', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-37', name: 'Samuel Eto\'o', birthDate: '1981-03-10', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-38', name: 'Frank Lampard', birthDate: '1978-06-20', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-39', name: 'Steven Gerrard', birthDate: '1980-05-30', sport: 'football', category: 'historical',
        clubs: [{ name: 'Liverpool', years: '1998-2015' }, { name: 'LA Galaxy', years: '2015-2016' }]
    },
    {
        id: 'f-40', name: 'Wayne Rooney', birthDate: '1985-10-24', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-41', name: 'Andrea Pirlo', birthDate: '1979-05-19', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-42', name: 'Fabio Cannavaro', birthDate: '1973-09-13', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-43', name: 'Luís Figo', birthDate: '1972-11-04', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-44', name: 'David Beckham', birthDate: '1975-05-02', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-45', name: 'Raúl', birthDate: '1977-06-27', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-46', name: 'Carles Puyol', birthDate: '1978-04-13', sport: 'football', category: 'historical',
        clubs: [{ name: 'Barcelona', years: '1999-2014' }]
    },
    {
        id: 'f-47', name: 'Roberto Carlos', birthDate: '1973-04-10', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-48', name: 'Cafu', birthDate: '1970-06-07', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-49', name: 'Rivaldo', birthDate: '1972-04-19', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-50', name: 'Dennis Bergkamp', birthDate: '1969-05-10', sport: 'football', category: 'historical',
        clubs: [{ name: 'Ajax', years: '1986-1993' }, { name: 'Inter Milan', years: '1993-1995' }, { name: 'Arsenal', years: '1995-2006' }]
    },
    // Batch 3
    {
        id: 'f-51', name: 'Alessandro Del Piero', birthDate: '1974-11-09', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-52', name: 'Francesco Totti', birthDate: '1976-09-27', sport: 'football', category: 'historical',
        clubs: [{ name: 'Roma', years: '1993-2017' }]
    },
    {
        id: 'f-53', name: 'Ryan Giggs', birthDate: '1973-11-29', sport: 'football', category: 'historical',
        clubs: [{ name: 'Man Utd', years: '1990-2014' }]
    },
    {
        id: 'f-54', name: 'Paul Scholes', birthDate: '1974-11-16', sport: 'football', category: 'historical',
        clubs: [{ name: 'Man Utd', years: '1993-2011' }, { name: 'Man Utd', years: '2012-2013' }]
    },
    {
        id: 'f-55', name: 'Philipp Lahm', birthDate: '1983-11-11', sport: 'football', category: 'historical',
        clubs: [{ name: 'Bayern Munich', years: '2002-2017' }, { name: 'Stuttgart', years: '2003-2005' }]
    },
    {
        id: 'f-56', name: 'Thomas Müller', birthDate: '1989-09-13', sport: 'football', category: 'historical',
        clubs: [{ name: 'Bayern Munich', years: '2008-' }]
    },
    {
        id: 'f-57', name: 'Bastian Schweinsteiger', birthDate: '1984-08-01', sport: 'football', category: 'historical',
        clubs: [{ name: 'Bayern Munich', years: '2002-2015' }, { name: 'Man Utd', years: '2015-2017' }, { name: 'Chicago Fire', years: '2017-2019' }]
    },
    {
        id: 'f-58', name: 'Arjen Robben', birthDate: '1984-01-23', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-59', name: 'Franck Ribéry', birthDate: '1983-04-07', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-60', name: 'Sergio Busquets', birthDate: '1988-07-16', sport: 'football', category: 'active',
        clubs: [{ name: 'Barcelona', years: '2008-2023' }, { name: 'Inter Miami', years: '2023-' }]
    },
    {
        id: 'f-61', name: 'Gerard Piqué', birthDate: '1987-02-02', sport: 'football', category: 'historical',
        clubs: [{ name: 'Man Utd', years: '2004-2008' }, { name: 'Zaragoza', years: '2006-2007' }, { name: 'Barcelona', years: '2008-2022' }]
    },
    {
        id: 'f-62', name: 'Dani Alves', birthDate: '1983-05-06', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-63', name: 'Marcelo', birthDate: '1988-05-12', sport: 'football', category: 'active',
    ...
    {
        id: 'f-64', name: 'Thiago Silva', birthDate: '1984-09-22', sport: 'football', category: 'active',
    ...
    {
        id: 'f-65', name: 'Zico', birthDate: '1953-03-03', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-66', name: 'Sérgio Agüero', birthDate: '1988-06-02', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-67', name: 'David Silva', birthDate: '1986-01-08', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-68', name: 'Vincent Kompany', birthDate: '1986-04-10', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-69', name: 'Yaya Touré', birthDate: '1983-05-13', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-70', name: 'Patrick Vieira', birthDate: '1976-06-23', sport: 'football', category: 'historical',
    ...
    // Batch 4 (71-100)
    {
        id: 'f-71', name: 'George Best', birthDate: '1946-05-22', sport: 'football', category: 'historical',
        clubs: [{ name: 'Man Utd', years: '1963-1974' }, { name: 'Fulham', years: '1976-1977' }]
    },
    {
        id: 'f-72', name: 'Bobby Charlton', birthDate: '1937-10-11', sport: 'football', category: 'historical',
        clubs: [{ name: 'Man Utd', years: '1956-1973' }]
    },
    {
        id: 'f-73', name: 'Eusébio', birthDate: '1942-01-25', sport: 'football', category: 'historical',
        clubs: [{ name: 'Benfica', years: '1960-1975' }]
    },
    {
        id: 'f-74', name: 'Gerd Müller', birthDate: '1945-11-03', sport: 'football', category: 'historical',
        clubs: [{ name: 'Bayern Munich', years: '1964-1979' }]
    },
    {
        id: 'f-75', name: 'Marco van Basten', birthDate: '1964-10-31', sport: 'football', category: 'historical',
        clubs: [{ name: 'Ajax', years: '1981-1987' }, { name: 'AC Milan', years: '1987-1995' }]
    },
    {
        id: 'f-76', name: 'Ruud Gullit', birthDate: '1962-09-01', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-77', name: 'Lev Yashin', birthDate: '1929-10-22', sport: 'football', category: 'historical',
        clubs: [{ name: 'Dynamo Moscow', years: '1950-1970' }]
    },
    {
        id: 'f-78', name: 'Ferenc Puskás', birthDate: '1927-04-01', sport: 'football', category: 'historical',
        clubs: [{ name: 'Budapest Honvéd', years: '1943-1955' }, { name: 'Real Madrid', years: '1958-1966' }]
    },
    {
        id: 'f-79', name: 'Alfredo Di Stéfano', birthDate: '1926-07-04', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-80', name: 'Garrincha', birthDate: '1933-10-28', sport: 'football', category: 'historical',
        clubs: [{ name: 'Botafogo', years: '1953-1965' }]
    },
    {
        id: 'f-81', name: 'Hugo Lloris', birthDate: '1986-12-26', sport: 'football', category: 'active',
        clubs: [{ name: 'Nice', years: '2005-2008' }, { name: 'Lyon', years: '2008-2012' }, { name: 'Tottenham', years: '2012-2024' }, { name: 'LAFC', years: '2024-' }]
    },
    {
        id: 'f-82', name: 'Olivier Giroud', birthDate: '1986-09-30', sport: 'football', category: 'active',
    ...
    {
        id: 'f-83', name: 'Ángel Di María', birthDate: '1988-02-14', sport: 'football', category: 'active',
    ...
    {
        id: 'f-84', name: 'Edinson Cavani', birthDate: '1987-02-14', sport: 'football', category: 'active',
    ...
    {
        id: 'f-85', name: 'Radamel Falcao', birthDate: '1986-02-10', sport: 'football', category: 'active',
    ...
    {
        id: 'f-86', name: 'Alexis Sánchez', birthDate: '1988-12-19', sport: 'football', category: 'active',
    ...
    {
        id: 'f-87', name: 'Arturo Vidal', birthDate: '1987-05-22', sport: 'football', category: 'active',
    ...
    {
        id: 'f-88', name: 'James Rodríguez', birthDate: '1991-07-12', sport: 'football', category: 'active',
    ...
    {
        id: 'f-89', name: 'Mesut Özil', birthDate: '1988-10-15', sport: 'football', category: 'historical',
    ...
    {
        id: 'f-90', name: 'Mats Hummels', birthDate: '1988-12-16', sport: 'football', category: 'active',
    ...
    {
        id: 'f-91', name: 'Romelu Lukaku', birthDate: '1993-05-13', sport: 'football', category: 'active',
    ...
    {
        id: 'f-92', name: 'Thibaut Courtois', birthDate: '1992-05-11', sport: 'football', category: 'active',
    ...
    {
        id: 'f-93', name: 'Jan Oblak', birthDate: '1993-01-07', sport: 'football', category: 'active',
        clubs: [{ name: 'Olimpija Ljubljana', years: '2009-2010' }, { name: 'Benfica', years: '2010-2014' }, { name: 'Atlético Madrid', years: '2014-' }]
    },
    {
        id: 'f-94', name: 'Alisson Becker', birthDate: '1992-10-02', sport: 'football', category: 'active',
        clubs: [{ name: 'Internacional', years: '2013-2016' }, { name: 'Roma', years: '2016-2018' }, { name: 'Liverpool', years: '2018-' }]
    },
    {
        id: 'f-95', name: 'Roberto Firmino', birthDate: '1991-10-02', sport: 'football', category: 'active',
    ...
    {
        id: 'f-96', name: 'Casemiro', birthDate: '1992-02-23', sport: 'football', category: 'active',
        clubs: [{ name: 'São Paulo', years: '2010-2013' }, { name: 'Real Madrid', years: '2013-2022' }, { name: 'Porto', years: '2014-2015' }, { name: 'Man Utd', years: '2022-' }]
    },
    {
        id: 'f-97', name: 'Marquinhos', birthDate: '1994-05-14', sport: 'football', category: 'active',
        clubs: [{ name: 'Corinthians', years: '2012' }, { name: 'Roma', years: '2012-2013' }, { name: 'PSG', years: '2013-' }]
    },
    {
        id: 'f-98', name: 'Marco Verratti', birthDate: '1992-11-05', sport: 'football', category: 'active',
        clubs: [{ name: 'Pescara', years: '2008-2012' }, { name: 'PSG', years: '2012-2023' }, { name: 'Al-Arabi', years: '2023-' }]
    },
    {
        id: 'f-99', name: 'Giorgio Chiellini', birthDate: '1984-08-14', sport: 'football', category: 'historical',
