...
export const basketballPlayers: Player[] = [
    // Legends
    {
        id: 'b-1', name: 'Michael Jordan', birthDate: '1963-02-17', sport: 'basketball',
        clubs: [{ name: 'Chicago Bulls', years: '1984-1998' }, { name: 'Washington Wizards', years: '2001-2003' }]
    },
    {
        id: 'b-2', name: 'LeBron James', birthDate: '1984-12-30', sport: 'basketball',
    ...
    {
        id: 'b-3', name: 'Kobe Bryant', birthDate: '1978-08-23', sport: 'basketball',
        clubs: [{ name: 'LA Lakers', years: '1996-2016' }]
    },
    {
        id: 'b-4', name: 'Shaquille O\'Neal', birthDate: '1972-03-06', sport: 'basketball',
    ...
    {
        id: 'b-15', name: 'Giannis Antetokounmpo', birthDate: '1994-12-06', sport: 'basketball',
        clubs: [{ name: 'Filathlitikos', years: '2011-2013' }, { name: 'Milwaukee Bucks', years: '2013-' }]
    },
    {
        id: 'b-16', name: 'Luka Dončić', birthDate: '1999-02-28', sport: 'basketball',
        clubs: [{ name: 'Real Madrid', years: '2015-2018' }, { name: 'Dallas Mavericks', years: '2018-' }]
    },
    {
        id: 'b-17', name: 'Nikola Jokić', birthDate: '1995-02-19', sport: 'basketball',
        clubs: [{ name: 'Mega Basket', years: '2012-2015' }, { name: 'Denver Nuggets', years: '2015-' }]
    },
    {
        id: 'b-18', name: 'Joel Embiid', birthDate: '1994-03-16', sport: 'basketball',
        clubs: [{ name: 'Philadelphia 76ers', years: '2014-' }]
    },
    {
        id: 'b-19', name: 'James Harden', birthDate: '1989-08-26', sport: 'basketball',
    ...
    {
        id: 'b-20', name: 'Kawhi Leonard', birthDate: '1991-06-29', sport: 'basketball',
        clubs: [{ name: 'San Antonio Spurs', years: '2011-2018' }, { name: 'Toronto Raptors', years: '2018-2019' }, { name: 'LA Clippers', years: '2019-' }]
    },
    {
        id: 'b-21', name: 'Russell Westbrook', birthDate: '1988-11-12', sport: 'basketball',
    ...
    {
        id: 'b-22', name: 'Chris Paul', birthDate: '1985-05-06', sport: 'basketball',
    ...
    {
        id: 'b-23', name: 'Damian Lillard', birthDate: '1990-07-15', sport: 'basketball',
        clubs: [{ name: 'Portland Trail Blazers', years: '2012-2023' }, { name: 'Milwaukee Bucks', years: '2023-' }]
    },
    {
        id: 'b-24', name: 'Anthony Davis', birthDate: '1993-03-11', sport: 'basketball',
        clubs: [{ name: 'New Orleans Pelicans', years: '2012-2019' }, { name: 'LA Lakers', years: '2019-' }]
    },
    {
        id: 'b-25', name: 'Kyrie Irving', birthDate: '1992-03-23', sport: 'basketball',
    ...
    {
        id: 'b-26', name: 'Jimmy Butler', birthDate: '1989-09-14', sport: 'basketball',
    ...
    {
        id: 'b-27', name: 'Jayson Tatum', birthDate: '1998-03-03', sport: 'basketball',
        clubs: [{ name: 'Boston Celtics', years: '2017-' }]
    },
    {
        id: 'b-28', name: 'Victor Wembanyama', birthDate: '2004-01-04', sport: 'basketball',
    ...
    {
        id: 'b-29', name: 'Rudy Gobert', birthDate: '1992-06-26', sport: 'basketball',
        clubs: [{ name: 'Cholet', years: '2010-2013' }, { name: 'Utah Jazz', years: '2013-2022' }, { name: 'Minnesota Timberwolves', years: '2022-' }]
    },
    {
        id: 'b-30', name: 'Paul George', birthDate: '1990-05-02', sport: 'basketball',
    ...
    // Icons
    {
        id: 'b-31', name: 'Charles Barkley', birthDate: '1963-02-20', sport: 'basketball',
        clubs: [{ name: 'Philadelphia 76ers', years: '1984-1992' }, { name: 'Phoenix Suns', years: '1992-1996' }, { name: 'Houston Rockets', years: '1996-2000' }]
    },
    {
        id: 'b-32', name: 'Karl Malone', birthDate: '1963-07-24', sport: 'basketball',
        clubs: [{ name: 'Utah Jazz', years: '1985-2003' }, { name: 'LA Lakers', years: '2003-2004' }]
    },
    {
        id: 'b-33', name: 'John Stockton', birthDate: '1962-03-26', sport: 'basketball',
        clubs: [{ name: 'Utah Jazz', years: '1984-2003' }]
    },
    {
        id: 'b-34', name: 'Scottie Pippen', birthDate: '1965-09-25', sport: 'basketball',
    ...
    {
        id: 'b-35', name: 'Dennis Rodman', birthDate: '1961-05-13', sport: 'basketball',
    ...
    {
        id: 'b-36', name: 'David Robinson', birthDate: '1965-08-06', sport: 'basketball',
        clubs: [{ name: 'San Antonio Spurs', years: '1989-2003' }]
    },
    {
        id: 'b-37', name: 'Patrick Ewing', birthDate: '1962-08-05', sport: 'basketball',
        clubs: [{ name: 'New York Knicks', years: '1985-2000' }, { name: 'Seattle SuperSonics', years: '2000-2001' }, { name: 'Orlando Magic', years: '2001-2002' }]
    },
    {
        id: 'b-38', name: 'Reggie Miller', birthDate: '1965-08-24', sport: 'basketball',
        clubs: [{ name: 'Indiana Pacers', years: '1987-2005' }]
    },
    {
        id: 'b-39', name: 'Jason Kidd', birthDate: '1973-03-23', sport: 'basketball',
    ...
    {
        id: 'b-40', name: 'Steve Nash', birthDate: '1974-02-07', sport: 'basketball',
    ...
    {
        id: 'b-41', name: 'Allen Iverson', birthDate: '1975-06-07', sport: 'basketball',
    ...
    {
        id: 'b-42', name: 'Vince Carter', birthDate: '1977-01-26', sport: 'basketball',
    ...
    {
        id: 'b-43', name: 'Tracy McGrady', birthDate: '1979-05-24', sport: 'basketball',
        clubs: [{ name: 'Toronto Raptors', years: '1997-2000' }, { name: 'Orlando Magic', years: '2000-2004' }, { name: 'Houston Rockets', years: '2004-2010' }]
    },
    {
        id: 'b-44', name: 'Paul Pierce', birthDate: '1977-10-13', sport: 'basketball',
    ...
    {
        id: 'b-45', name: 'Ray Allen', birthDate: '1975-07-20', sport: 'basketball',
    ...
    {
        id: 'b-46', name: 'Kevin Garnett', birthDate: '1976-05-19', sport: 'basketball',
    ...
    {
        id: 'b-47', name: 'Dwight Howard', birthDate: '1985-12-08', sport: 'basketball',
    ...
    {
        id: 'b-48', name: 'Pau Gasol', birthDate: '1980-07-06', sport: 'basketball',
    ...
    {
        id: 'b-49', name: 'Carmelo Anthony', birthDate: '1984-05-29', sport: 'basketball',
    ...
    {
        id: 'b-50', name: 'Dwyane Wade', birthDate: '1982-01-17', sport: 'basketball',
    ...
    // Batch 3
    {
        id: 'b-51', name: 'Clyde Drexler', birthDate: '1962-06-22', sport: 'basketball',
        clubs: [{ name: 'Portland Trail Blazers', years: '1983-1995' }, { name: 'Houston Rockets', years: '1995-1998' }]
    },
    {
        id: 'b-52', name: 'Isiah Thomas', birthDate: '1961-04-30', sport: 'basketball',
        clubs: [{ name: 'Detroit Pistons', years: '1981-1994' }]
    },
    {
        id: 'b-53', name: 'James Worthy', birthDate: '1961-02-27', sport: 'basketball',
        clubs: [{ name: 'LA Lakers', years: '1982-1994' }]
    },
    {
        id: 'b-54', name: 'Dominique Wilkins', birthDate: '1960-01-12', sport: 'basketball',
    ...
    {
        id: 'b-55', name: 'Gary Payton', birthDate: '1968-07-23', sport: 'basketball',
    ...
    {
        id: 'b-56', name: 'Shawn Kemp', birthDate: '1969-11-26', sport: 'basketball',
    ...
    {
        id: 'b-57', name: 'Manu Ginóbili', birthDate: '1977-07-28', sport: 'basketball',
    ...
    {
        id: 'b-58', name: 'Yao Ming', birthDate: '1980-09-12', sport: 'basketball',
        clubs: [{ name: 'Shanghai Sharks', years: '1997-2002' }, { name: 'Houston Rockets', years: '2002-2011' }]
    },
    {
        id: 'b-59', name: 'Chris Bosh', birthDate: '1984-03-24', sport: 'basketball',
        clubs: [{ name: 'Toronto Raptors', years: '2003-2010' }, { name: 'Miami Heat', years: '2010-2016' }]
    },
    {
        id: 'b-60', name: 'Klay Thompson', birthDate: '1990-02-08', sport: 'basketball',
        clubs: [{ name: 'Golden State Warriors', years: '2011-2024' }, { name: 'Dallas Mavericks', years: '2024-' }]
    },
    {
        id: 'b-61', name: 'Draymond Green', birthDate: '1990-03-04', sport: 'basketball',
        clubs: [{ name: 'Golden State Warriors', years: '2012-' }]
    },
    {
        id: 'b-62', name: 'DeMar DeRozan', birthDate: '1989-08-07', sport: 'basketball',
    ...
    {
        id: 'b-63', name: 'Blake Griffin', birthDate: '1989-03-16', sport: 'basketball',
    ...
    {
        id: 'b-64', name: 'Derrick Rose', birthDate: '1988-10-04', sport: 'basketball',
    ...
    {
        id: 'b-65', name: 'Paul Gasol', birthDate: '1980-07-06', sport: 'basketball',
    ...
    {
        id: 'b-66', name: 'Marc Gasol', birthDate: '1985-01-29', sport: 'basketball',
    ...
    {
        id: 'b-67', name: 'Anthony Edwards', birthDate: '2001-08-05', sport: 'basketball',
        clubs: [{ name: 'Minnesota Timberwolves', years: '2020-' }]
    },
    {
        id: 'b-68', name: 'Shai Gilgeous-Alexander', birthDate: '1998-07-12', sport: 'basketball',
        clubs: [{ name: 'LA Clippers', years: '2018-2019' }, { name: 'OKC Thunder', years: '2019-' }]
    },
    {
        id: 'b-69', name: 'Devin Booker', birthDate: '1996-10-30', sport: 'basketball',
        clubs: [{ name: 'Phoenix Suns', years: '2015-' }]
    },
    {
        id: 'b-70', name: 'Donovan Mitchell', birthDate: '1996-09-07', sport: 'basketball',
        clubs: [{ name: 'Utah Jazz', years: '2017-2022' }, { name: 'Cleveland Cavaliers', years: '2022-' }]
    },
    // Batch 4 (71-100)
    {
        id: 'b-71', name: 'Bill Russell', birthDate: '1934-02-12', sport: 'basketball',
        clubs: [{ name: 'Boston Celtics', years: '1956-1969' }]
    },
    {
        id: 'b-72', name: 'Jerry West', birthDate: '1938-05-28', sport: 'basketball',
        clubs: [{ name: 'LA Lakers', years: '1960-1974' }]
    },
    {
        id: 'b-73', name: 'Oscar Robertson', birthDate: '1938-11-24', sport: 'basketball',
        clubs: [{ name: 'Cincinnati Royals', years: '1960-1970' }, { name: 'Milwaukee Bucks', years: '1970-1974' }]
    },
    {
        id: 'b-74', name: 'Elgin Baylor', birthDate: '1934-09-16', sport: 'basketball',
        clubs: [{ name: 'LA Lakers', years: '1958-1971' }]
    },
    {
        id: 'b-75', name: 'Bob Cousy', birthDate: '1928-08-09', sport: 'basketball',
        clubs: [{ name: 'Boston Celtics', years: '1950-1963' }]
    },
    {
        id: 'b-76', name: 'John Havlicek', birthDate: '1940-04-08', sport: 'basketball',
        clubs: [{ name: 'Boston Celtics', years: '1962-1978' }]
    },
    {
        id: 'b-77', name: 'George Mikan', birthDate: '1924-06-18', sport: 'basketball',
        clubs: [{ name: 'Minneapolis Lakers', years: '1947-1956' }]
    },
    {
        id: 'b-78', name: 'Bob Pettit', birthDate: '1932-12-12', sport: 'basketball',
        clubs: [{ name: 'St. Louis Hawks', years: '1954-1965' }]
    },
    {
        id: 'b-79', name: 'Rick Barry', birthDate: '1944-03-28', sport: 'basketball',
    ...
    {
        id: 'b-80', name: 'Willis Reed', birthDate: '1942-06-25', sport: 'basketball',
        clubs: [{ name: 'New York Knicks', years: '1964-1974' }]
    },
    {
        id: 'b-81', name: 'Alonzo Mourning', birthDate: '1970-02-08', sport: 'basketball',
    ...
    {
        id: 'b-82', name: 'Dikembe Mutombo', birthDate: '1966-06-25', sport: 'basketball',
    ...
    {
        id: 'b-83', name: 'Grant Hill', birthDate: '1972-10-05', sport: 'basketball',
    ...
    {
        id: 'b-84', name: 'Penny Hardaway', birthDate: '1971-07-18', sport: 'basketball',
    ...
    {
        id: 'b-85', name: 'Chris Webber', birthDate: '1973-03-01', sport: 'basketball',
    ...
    {
        id: 'b-86', name: 'Peja Stojaković', birthDate: '1977-06-09', sport: 'basketball',
    ...
    {
        id: 'b-87', name: 'Steve Kerr', birthDate: '1965-09-27', sport: 'basketball',
    ...
    {
        id: 'b-88', name: 'Robert Horry', birthDate: '1970-08-25', sport: 'basketball',
        clubs: [{ name: 'Houston Rockets', years: '1992-1996' }, { name: 'LA Lakers', years: '1997-2003' }, { name: 'San Antonio Spurs', years: '2003-2008' }]
    },
    {
        id: 'b-89', name: 'Ben Wallace', birthDate: '1974-09-10', sport: 'basketball',
    ...
    {
        id: 'b-90', name: 'Trae Young', birthDate: '1998-09-19', sport: 'basketball',
        clubs: [{ name: 'Atlanta Hawks', years: '2018-' }]
    },
    {
        id: 'b-91', name: 'Ja Morant', birthDate: '1999-08-10', sport: 'basketball',
        clubs: [{ name: 'Memphis Grizzlies', years: '2019-' }]
    },
    {
        id: 'b-92', name: 'Zion Williamson', birthDate: '2000-07-06', sport: 'basketball',
        clubs: [{ name: 'New Orleans Pelicans', years: '2019-' }]
    },
    {
        id: 'b-93', name: 'Bam Adebayo', birthDate: '1997-07-18', sport: 'basketball',
        clubs: [{ name: 'Miami Heat', years: '2017-' }]
    },
    {
        id: 'b-94', name: 'De\'Aaron Fox', birthDate: '1997-12-20', sport: 'basketball',
        clubs: [{ name: 'Sacramento Kings', years: '2017-' }]
    },
    {
        id: 'b-95', name: 'Domantas Sabonis', birthDate: '1996-05-03', sport: 'basketball',
    ...
    {
        id: 'b-96', name: 'Pascal Siakam', birthDate: '1994-04-02', sport: 'basketball',
        clubs: [{ name: 'Toronto Raptors', years: '2016-2024' }, { name: 'Indiana Pacers', years: '2024-' }]
    },
    {
        id: 'b-97', name: 'Brandon Ingram', birthDate: '1997-09-02', sport: 'basketball',
        clubs: [{ name: 'LA Lakers', years: '2016-2019' }, { name: 'New Orleans Pelicans', years: '2019-' }]
    },
    {
        id: 'b-98', name: 'Jaylen Brown', birthDate: '1996-10-24', sport: 'basketball',
        clubs: [{ name: 'Boston Celtics', years: '2016-' }]
    },
    {
        id: 'b-99', name: 'Jamal Murray', birthDate: '1997-02-23', sport: 'basketball',
        clubs: [{ name: 'Denver Nuggets', years: '2016-' }]
    },
    {
        id: 'b-100', name: 'LaMelo Ball', birthDate: '2001-08-22', sport: 'basketball',
